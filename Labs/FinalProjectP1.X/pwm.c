...
#define TRIS_B4 TRISBbits.TRISB4

#define LAT_B8 LATBbits.LATB8
#define LAT_B4 LATBbits.LATB4
#define LAT_B3 LATBbits.LATB3
#define LAT_B9 LATBbits.LATB9

#define RPOR_RP4R RPOR2bits.RP4R
...
RPOR_RP4R = OC1; // map OC1 to pin 6
...
RPOR_RP4R = RESET; // map OC1 to pin 6
RPOR_RP8R = RESET; // map OC2 to pin 17

LAT_B4 = RESET; // Pin 6 to low to go backwards
